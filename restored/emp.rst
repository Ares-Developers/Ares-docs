...
First we will look at positive :tag:`EMP.Duration` - the targets are going to be
paralyzed.
...
Next we will look at negative :tag:`EMP.Duration` - for example, a friendly unit
trying to re-activate the already-paralyzed unit.
